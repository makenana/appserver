...
namespace appserver
{
    public class JwtHandler(IConfiguration configuration, UserManager<CityParkUser> userManager)
    {
        //Generates the JWT token
        public async Task<JwtSecurityToken> GetTokenAsync(CityParkUser user) =>
        new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(CityParkUser user)
        {
